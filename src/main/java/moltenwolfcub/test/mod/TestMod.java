...
public class TestMod implements ModInitializer {
	...
	public static final Block NON_FRICTION_BLOCK = new Block(FabricBlockSettings.of(Material.DECORATION).strength(0F, 0F).breakInstantly().slipperiness(1.5F).nonOpaque());
